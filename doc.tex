...
\node at (0.5,2) {input layer};    % Adjust (x,y) coordinates as needed
  \node at (2.5,2) {hidden layers};  % Adjust (x,y) coordinates as needed
  \node at (4.5,2) {output layer};   % Adjust (x,y) coordinates as needed
